...
const ModalContent = () => {
  return (
    <div className="space-y-6 pb-4">
      <section>
        <h2 className="text-xl sm:text-2xl text-text font-medium mb-3">
          Here's how it works:
        </h2>
        <ul className="space-y-2 list-disc pl-5 text-base sm:text-lg">
          <li className="text-text">
            Be one of the first 200 people to join our waitlist.
          </li>
          <li className="text-text-muted">
            Use MainFocus to earn Focus Points by crushing your goals and staying in the zone.
          </li>
          <li className="text-text-muted">
            Compete with fellow early adopters to climb the leaderboard.
          </li>
        </ul>
      </section>
      ...
      <section className="space-y-3">
        <p className="text-lg sm:text-xl lg:text-2xl text-text">
          ...
          Let's make productivity fun, rewarding, and a little bit competitive!
        </p>
        <p className="text-lg sm:text-xl lg:text-2xl text-text">
          👉 <span className="font-bold">Spots are limited,</span> so act fast.
          Join the waitlist today and secure your place in the game!{' '}
          <span className="font-bold">Ready, set... FOCUS! 🏆</span>
        </p>
      </section>
    </div>
  );
