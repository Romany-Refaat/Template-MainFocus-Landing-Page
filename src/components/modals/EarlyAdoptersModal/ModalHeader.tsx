...
const ModalHeader = () => {
  return (
    <div className="sticky top-0 bg-background pt-4 pb-6 z-10">
      ...
      <p className="text-sm sm:text-base lg:text-lg text-text-muted mt-2">
        We're thrilled to announce the{' '}
        <span className="text-text">MainFocus Early Adopters Competition</span>{' '}
        – your chance to turn focus into fantastic{' '}
